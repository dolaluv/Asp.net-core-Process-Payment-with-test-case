...
{
    public class PaymentServices : ICheapPaymentGateway, IExpensivePaymentGateway, IPremiumPaymentService,IPaymentGateway
    {

        private PaymentAccessPortalContext _PaymentAccessPortalContext;

        public PaymentServices(PaymentAccessPortalContext paymentAccessPortalContext)
        {
